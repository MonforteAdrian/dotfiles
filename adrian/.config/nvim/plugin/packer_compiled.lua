...
_G.packer_plugins = {
  dracula = {
    loaded = true,
    path = "/home/adrian/.local/share/nvim/site/pack/packer/start/dracula",
    url = "/home/adrian/dracula"
  },
  ["impatient.nvim"] = {
    loaded = true,
  ...
  neorg = {
    loaded = true,
    path = "/home/adrian/.local/share/nvim/site/pack/packer/start/neorg",
  ...
  ["tabline.nvim"] = {
    loaded = true,
    path = "/home/adrian/.local/share/nvim/site/pack/packer/start/tabline.nvim",
  ...
  ["toggleterm.nvim"] = {
    loaded = true,
    path = "/home/adrian/.local/share/nvim/site/pack/packer/start/toggleterm.nvim",
    url = "https://github.com/akinsho/toggleterm.nvim"
  },
  ["vim-css-color"] = {
    loaded = true,
    path = "/home/adrian/.local/share/nvim/site/pack/packer/start/vim-css-color",
