...
/* Mononoki Nerd Font must be installed.
...
static const char *fonts[]     = {
                                  "SourceCodePro:size=8",
                                  "SauceCodePro Nerd Font Mono:weight=bold:size=8:antialias=true:hinting=true",
                                  "Mononoki:size=6:antialias=true:autohint=true",
...
// DRACULA
static const char col_4[]  = "#BD93F9"; /* border color focused windows and tags */
...
static Key keys[] = {
	...
	{ MODKEY|Mod1Mask,        XK_e,    spawn,          CMD("st -e nvim") },
  ...
  */
	...
	{ MODKEY|ControlMask, XK_e,      spawn,          CMD("./.dmenu/dmenu-edit-configs.sh") },
	{ MODKEY|ControlMask, XK_m,      spawn,          CMD("./.dmenu/dmenu-sysmon.sh") },
	{ MODKEY|ControlMask, XK_p,      spawn,          CMD("passmenu") },
	{ MODKEY|ControlMask, XK_r,      spawn,          CMD("./.dmenu/dmenu-reddio.sh") },
	{ MODKEY|ControlMask, XK_s,      spawn,          CMD("./.dmenu/dmenu-surfraw.sh") },
	{ MODKEY|ControlMask, XK_i,      spawn,          CMD("./.dmenu/dmenu-scrot.sh") },
