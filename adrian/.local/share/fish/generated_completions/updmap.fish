# updmap
# Autogenerated from man page /usr/lib/jvm/default/man/man1/updmap.1.gz
...
complete -c updmap -l nohash -d 'do not run texhash'
...
complete -c updmap -l listmaps -d 'list all active and inactive maps'
complete -c updmap -l listavailablemaps -d 'same as --listmaps, but without unavailable map files'
complete -c updmap -l syncwithtrees -d 'disable unavailable map files in updmap. cfg '
