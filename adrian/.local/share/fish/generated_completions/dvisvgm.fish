# dvisvgm
# Autogenerated from man page /usr/lib/jvm/default/man/man1/dvisvgm.1.gz
...
complete -c dvisvgm -s E -l eps -d 'If this option is given, dvisvgm does not expect a DVI but an EPS input file,…'
...
complete -c dvisvgm -s o -l output -d 'Sets the pattern specifying the names of the generated SVG files'
...
complete -c dvisvgm -s R -l relative -d 'SVG allows to define graphics paths by a sequence of absolute and/or relative…'
