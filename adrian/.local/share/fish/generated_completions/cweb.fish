# cweb
# Autogenerated from man page /usr/lib/jvm/default/man/man1/cweb.1.gz
complete -c cweb -l version -s i -s o -s t -d 'and +lX are new in CWEBbin and TeX Live'
...
complete -c cweb -s x -d '[bu] 2 +lX/-lX: use macros for language X as of Xcwebmac. tex ENVIRONMENT'
