//! Isometric tools lib in rust.
//!
//! This lib allows you to:
//!
//! * Manipulate isometric coordinates
//! * Generate isometric maps
//!
//! ## Installation
//!
//! Run `cargo add isometric` in your project or add the following line to your
//! `Cargo.toml`:
//!
//! * `hexx = "0.17"`
//!
...
pub use iso::{iso, Iso};
#[doc(inline)]
pub use layout::IsoLayout;
#[doc(inline)]
pub use mapping::CHUNK_DIMENSIONS;
#[doc(inline)]
pub use tile_type::ProjectionMatrix;
